...
namespace QuickConnectPlugin.Tests.PasswordChanger.Services {
    ...
    public class PasswordChangerServiceWrapperTests {
        ...
        public void UpdateEntryPassword() {
            ...
            passwordChangerService.UpdateEntryPassword(hostPwEntryMock.Object, "newPassword");
        ...
        [Test]
        public void ChangePasswordPreservesOperationDetailsFromPasswordChanger() {
            var passwordDatabaseMock = new Mock<IPasswordDatabase>();
            var passwordChangerMock = new Mock<IPasswordChanger>();
            var passwordChangerResultInfoMock = passwordChangerMock.As<IPasswordChangerResultInfo>();
            passwordChangerResultInfoMock.SetupGet(x => x.LastOperationDetails).Returns("server response");
            ...
            Assert.AreEqual("server response", passwordChangerService.LastOperationDetails);
        }
    }
}
